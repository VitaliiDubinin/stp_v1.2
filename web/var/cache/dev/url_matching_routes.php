...
return [
    ...
    [ // $dynamicRoutes
        ...
        86 => [[['_route' => 'api_mainfind_a_recipe', '_controller' => 'App\\Controller\\ReceipeController::findRecipe'], ['id'], ['GET' => 0], null, false, true, null]],
        106 => [[['_route' => 'api_mainedit_a_recipe', '_controller' => 'App\\Controller\\ReceipeController::editRecipe'], ['id'], ['PUT' => 0, 'PATCH' => 1], null, false, true, null]],
        129 => [[['_route' => 'api_mainremove_a_recipe', '_controller' => 'App\\Controller\\ReceipeController::removeRecipe'], ['id'], ['DELETE' => 0], null, false, true, null]],
        152 => [
